...
mongoose.connect(`mongodb+srv://compass:${process.env.mongoP}@cluster0.d125p.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`, { useNewUrlParser: true, useUnifiedTopology: true }, err => {
